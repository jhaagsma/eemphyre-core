...
class Result{
    ...
    function message()
    {
        ...
        switch($this->type){
            ...
            case 'CLIENT_ADDED':            $this->set_success(); return 'Client added successfully.';
            
            case 'UNIT_ADDED':              $this->set_success(); return 'Unit added successfully.';

            case 'PROPERTY_ADDED':          $this->set_success(); return 'Property added successfully.';

            case 'TESTTYPE_ADDED':          $this->set_success(); return 'Test Type added successfully.';
